...
export const getAccountById = (_id: string): Account | undefined => {
  return undefined;
};

export const getAccountByUsername = (_username: string): Account | undefined => {
  return undefined;
};

export const getAccountsByRole = (_role: string): Account[] => {
  return [];
};

export const getAccountsByStatus = (_status: number): Account[] => {
  return [];
};
...
export const mockProducts: Product[] = [
  {
    ...
    images: [
      { id: 1, imageUrl: '/images/dac-nhan-tam-1.jpg', imageOrder: 0 },
      { id: 2, imageUrl: '/images/dac-nhan-tam-2.jpg', imageOrder: 1 }
    ],
    price: 89000,
    stock: 150,
  ...
  },
  {
    ...
    images: [
      { id: 3, imageUrl: '/images/sapiens-1.jpg', imageOrder: 0 },
      { id: 4, imageUrl: '/images/sapiens-2.jpg', imageOrder: 1 },
      { id: 5, imageUrl: '/images/sapiens-3.jpg', imageOrder: 2 }
    ],
    price: 299000,
    stock: 75,
  ...
  },
  {
    ...
    categories: [mockCategories[3]], // Tâm lý - Kỹ năng sống
    images: [
      { id: 6, imageUrl: '/images/toi-tai-gioi-1.jpg', imageOrder: 0 }
    ],
    price: 79000,
    stock: 200,
  ...
  },
  {
    ...
    images: [
      { id: 7, imageUrl: '/images/kinh-te-vi-mo-1.jpg', imageOrder: 0 },
      { id: 8, imageUrl: '/images/kinh-te-vi-mo-2.jpg', imageOrder: 1 }
    ],
    price: 450000,
    stock: 50,
  ...
  },
  {
    ...
    images: [
      { id: 9, imageUrl: '/images/thanh-pho-tinh-yeu-1.jpg', imageOrder: 0 }
    ],
    price: 65000,
    stock: 120,
  ...
  },
  {
    ...
    images: [
      { id: 10, imageUrl: '/images/python-co-ban-1.jpg', imageOrder: 0 },
      { id: 11, imageUrl: '/images/python-co-ban-2.jpg', imageOrder: 1 }
    ],
    price: 199000,
    stock: 80,
  ...
  },
  {
    ...
    images: [
      { id: 12, imageUrl: '/images/doraemon-15-1.jpg', imageOrder: 0 }
    ],
    price: 25000,
    stock: 300,
  ...
  },
  {
    ...
    images: [
      { id: 13, imageUrl: '/images/triet-hoc-phuong-dong-1.jpg', imageOrder: 0 },
      { id: 14, imageUrl: '/images/triet-hoc-phuong-dong-2.jpg', imageOrder: 1 }
    ],
    price: 350000,
    stock: 45,
  ...
  },
  {
    ...
    images: [
      { id: 15, imageUrl: '/images/english-grammar-1.jpg', imageOrder: 0 }
    ],
    price: 180000,
    stock: 95,
  ...
  },
  {
    ...
    images: [
      { id: 16, imageUrl: '/images/toan-12-sgk-1.jpg', imageOrder: 0 }
    ],
    price: 45000,
    stock: 250,
  ...
  },
  {
    ...
    categories: [mockCategories[0]], // Văn học
    images: [
      { id: 17, imageUrl: '/images/nguoi-khong-lo-1.jpg', imageOrder: 0 },
      { id: 18, imageUrl: '/images/nguoi-khong-lo-2.jpg', imageOrder: 1 }
    ],
    price: 420000,
    stock: 30,
  ...
  },
  {
    ...
    categories: [mockCategories[3]], // Tâm lý - Kỹ năng sống
    images: [
      { id: 19, imageUrl: '/images/quan-ly-thoi-gian-1.jpg', imageOrder: 0 }
    ],
    price: 95000,
    stock: 110,
...
export const getProductsByAuthor = (_author: string): Product[] => {
...
export const mockOrders: Order[] = [
  {
    ...
    items: [
      {
        id: 1,
        product: { ...mockProducts[0], images: [{ id: 1, imageUrl: '/banner1.jpg', imageOrder: 0 }] },
        quantity: 2,
        price: 89000,
        total: 178000
      },
      {
        id: 2,
        product: { ...mockProducts[2], images: [{ id: 2, imageUrl: '/banner2.jpg', imageOrder: 0 }] },
        quantity: 1,
        price: 79000,
        total: 79000
      }
  ...
  },
  {
    ...
    items: [
      {
        id: 3,
        product: { ...mockProducts[1], images: [{ id: 3, imageUrl: '/banner3.jpg', imageOrder: 0 }] },
        quantity: 1,
        price: 299000,
        total: 299000
      },
      {
        id: 4,
        product: { ...mockProducts[5], images: [{ id: 4, imageUrl: '/banner4.jpg', imageOrder: 0 }] },
        quantity: 1,
        price: 65000,
        total: 65000
      },
      {
        id: 5,
        product: { ...mockProducts[6], images: [{ id: 5, imageUrl: '/banner1.jpg', imageOrder: 0 }] },
        quantity: 1,
        price: 199000,
        total: 199000
      }
  ...
  },
  {
    ...
    items: [
      {
        id: 6,
        product: { ...mockProducts[3], images: [{ id: 6, imageUrl: '/banner2.jpg', imageOrder: 0 }] },
        quantity: 1,
        price: 450000,
        total: 450000
      }
  ...
  },
  {
    ...
    items: [
      {
        id: 7,
        product: { ...mockProducts[7], images: [{ id: 7, imageUrl: '/banner3.jpg', imageOrder: 0 }] },
        quantity: 3,
        price: 25000,
        total: 75000
      },
      {
        id: 8,
        product: { ...mockProducts[8], images: [{ id: 8, imageUrl: '/banner4.jpg', imageOrder: 0 }] },
        quantity: 1,
        price: 350000,
        total: 350000
      },
      {
        id: 9,
        product: { ...mockProducts[9], images: [{ id: 9, imageUrl: '/banner1.jpg', imageOrder: 0 }] },
        quantity: 1,
        price: 180000,
        total: 180000
      }
  ...
  },
  {
    ...
    items: [
      {
        id: 10,
        product: { ...mockProducts[10], images: [{ id: 10, imageUrl: '/banner2.jpg', imageOrder: 0 }] },
        quantity: 2,
        price: 45000,
        total: 90000
      },
      {
        id: 11,
        product: { ...mockProducts[11], images: [{ id: 11, imageUrl: '/banner3.jpg', imageOrder: 0 }] },
        quantity: 1,
        price: 420000,
        total: 420000
      }
