            ...
            <div className="lg:col-span-1">
             ...
             <div className="lg:col-span-2">
               <div className="bg-white rounded-lg border border-gray-200 p-6 space-y-4">
                 ...
                 <div>
                   <label className="text-xs font-medium text-gray-600 mb-1 block">Thông tin sản phẩm</label>
                   <div className="flex items-center justify-between">
                     <div className="flex items-center gap-2">
                       <span className="text-base font-bold text-red-600">[Mã SP: {product.productId}]</span>
                       <span className="text-lg font-bold text-blue-800">- {product.productName}</span>
                     </div>
                     <Badge 
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                   <div>
                     ...
                     <p className="text-lg font-bold text-red-700">Giá: {formatPrice(product.price)}</p>
                     <p className="text-xs text-gray-500 mt-1">({numberToVietnameseWords(product.price)} đồng)</p>
                   </div>
                   <div>
                     <label className="text-xs font-medium text-gray-600 mb-1 block flex items-center gap-1">
