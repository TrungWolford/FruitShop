      ...
      if (response && response.content) {
        ...
        const transformedProducts = randomProducts.map((product: any) => {
          ...
          return {
            ...
            price: product.price,
            imageUrl: product.images && product.images.length > 0 ? `/products/${product.images[0].imageUrl}` : undefined,
            images: product.images && product.images.length > 0 ? product.images.map((img: any) => `/products/${img.imageUrl}`) : undefined,
