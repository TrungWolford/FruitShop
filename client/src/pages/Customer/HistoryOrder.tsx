                          ...
                          <div className="relative">
                            ...
                            <div className="flex justify-between mt-2">
                              <div className="flex flex-col items-center">
                                <div
                                  className={`w-6 h-6  flex items-center justify-center text-xs font-medium ${currentStep >= 1
                              ...
                              <div className="flex flex-col items-center">
                                <div
                                  className={`w-6 h-6  flex items-center justify-center text-xs font-medium ${currentStep >= 2
                              ...
                              <div className="flex flex-col items-center">
                                <div
                                  className={`w-6 h-6  flex items-center justify-center text-xs font-medium ${currentStep >= 3
                              ...
                              <div className="flex flex-col items-center">
                                <div
                                  className={`w-6 h-6  flex items-center justify-center text-xs font-medium ${currentStep >= 4
                            ...
                            {!isRejected && (
                              <div className="relative">
                                <div className="flex items-center">
                                  <div className="flex-1 h-2 bg-gray-200 overflow-hidden">
                                    <div
                                      className={`h-full transition-all duration-500 ${refundStep >= 1
                                  ...
                                  return (
                                    ...
                                    >
                                      ...
                                      <div className="flex-1">
                                        ...
                                        {detail?.status && (
                                          <div className="mt-1">
                                            <Badge className={`text-xs ${detail.status === 'returned'
            ...
            <div className="mb-6">
              ...
              <div className="flex gap-2 justify-center">
                {[1, 2, 3, 4, 5].map((star) => (
                  ...
                  >
                    <Star
                      className={`w-10 h-10 ${star <= ratingStars
