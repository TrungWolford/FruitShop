                ...
                <TableBody>
                  {categories.map((category, index) => (
                    <TableRow
                      ...
                      className={`hover:bg-gray-50 transition-all duration-200 cursor-pointer ${index % 2 === 0 ? 'bg-white' : 'bg-gray-50/50'
                        }`}
                    >
                      ...
                      <TableCell className="px-2 py-2">
                        <div className="flex justify-center">
                          <Badge
                            ...
                            className={`px-1.5 py-0.5 text-xs font-medium text-white whitespace-nowrap ${category.status === 1
