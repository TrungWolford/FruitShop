        ...
        <div className="bg-white shadow-sm border border-gray-200 overflow-hidden">
              ...
              <Table className="w-full">
                <TableHeader>
                  <TableRow className="bg-slate-800 hover:bg-slate-800 border-b border-slate-700">
                    ...
                    <TableHead className="font-semibold text-white px-2 py-2 text-left text-sm w-32">Tên Thể Loại</TableHead>
                      ...
                      <TableCell className="px-2 py-2">
                        <div className="flex items-center justify-center">
                          <div className="w-6 h-6 bg-purple-100 flex items-center justify-center">
                            <span className="text-xs font-bold text-purple-600">#{category.categoryId.slice(-6)}</span>
                          </div>
                        </div>
                      </TableCell>
                      <TableCell className="px-2 py-2">
          ...
          {!loading && categories.length === 0 && (
            <div className="text-center py-12 px-6">
              ...
              <p className="text-gray-500 mb-3 text-sm">Vui lòng thử lại với từ khóa khác hoặc thêm thể loại mới</p>
              <Button 
                onClick={() => setIsCreateModalOpen(true)}
