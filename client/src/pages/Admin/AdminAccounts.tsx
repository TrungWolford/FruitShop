    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="ml-64 p-4">
        ...
        <div className="mb-3">
          ...
          <p className="text-gray-600 mt-0.5 text-base">Quản lý tài khoản người dùng và phân quyền hệ thống</p>
        </div>
            ...
            <div className="flex gap-2 flex-1">
              ...
              <Select value={statusFilter} onValueChange={setStatusFilter}>
                ...
                <SelectContent className="bg-white border-gray-200 shadow-lg">
                  <SelectItem value="all" className="text-gray-900 hover:bg-gray-100">Tất cả</SelectItem>
                  <SelectItem value="active" className="text-gray-900 hover:bg-gray-100">Hoạt động</SelectItem>
                  <SelectItem value="inactive" className="text-gray-900 hover:bg-gray-100">Tạm ngưng</SelectItem>
                </SelectContent>
              </Select>
              ...
              <Select value={roleFilter} onValueChange={setRoleFilter}>
                ...
                <SelectContent className="bg-white border-gray-200 shadow-lg">
                  <SelectItem value="all" className="text-gray-900 hover:bg-gray-100">Tất cả</SelectItem>
                  {roles.map(role => (
                    <SelectItem key={role.roleId} value={role.roleId} className="text-gray-900 hover:bg-gray-100">
                      {role.roleName}
                    </SelectItem>
                  ))}
                </SelectContent>
        ...
        <div className="bg-white shadow-sm border border-gray-200 overflow-hidden">
              ...
              <Table className="w-full">
                <TableHeader>
                  <TableRow className="bg-slate-800 hover:bg-slate-800 border-b border-slate-700">
                    <TableHead className="font-semibold text-white px-2 py-2 text-center text-sm w-16">Mã</TableHead>
                    <TableHead className="font-semibold text-white px-2 py-2 text-left text-sm w-32">Tên tài khoản</TableHead>
                    <TableHead className="font-semibold text-white px-2 py-2 text-left text-sm w-32">Số điện thoại</TableHead>
                    <TableHead className="font-semibold text-white px-2 py-2 text-center text-sm w-24">Vai trò</TableHead>
                    <TableHead className="font-semibold text-white px-2 py-2 text-center text-sm w-20">Trạng thái</TableHead>
                    <TableHead className="font-semibold text-white px-2 py-2 text-center text-sm w-32">Thao tác</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                      ...
                      <TableCell className="px-2 py-2">
                        <div className="flex items-center justify-center">
                          <div className="w-6 h-6 bg-blue-100 flex items-center justify-center">
                            <span className="text-xs font-bold text-blue-600">#{account.accountId.slice(-6)}</span>
                          </div>
                        </div>
                      </TableCell>
                      <TableCell className="px-2 py-2">
                        <div className="font-medium text-gray-900 text-sm">{account.accountName}</div>
                      </TableCell>
                      <TableCell className="px-2 py-2 text-sm text-gray-600">{account.accountPhone}</TableCell>
                      <TableCell className="px-2 py-2">
          ...
          {!loading && accounts.length === 0 && (
            <div className="text-center py-12 px-6">
              ...
              <h3 className="text-base font-semibold text-gray-700 mb-2">Không tìm thấy tài khoản nào</h3>
              <p className="text-gray-500 mb-3 text-sm">Vui lòng thử lại với từ khóa khác hoặc thêm tài khoản mới</p>
              <Button 
                onClick={() => setIsCreateModalOpen(true)}
        ...
        <Dialog open={isDeleteModalOpen} onOpenChange={setIsDeleteModalOpen}>
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Bạn có chắc chắn muốn xóa tài khoản "{selectedAccount?.accountName}"? 
