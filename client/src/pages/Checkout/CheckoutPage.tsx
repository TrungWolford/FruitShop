...
const CheckoutPage: React.FC = () => {
  ...
  const handlePlaceOrder = async () => {
    ...
    // Validation
    if (!shippingData.receiverName || !shippingData.receiverPhone || !shippingData.address || !shippingData.ward || !shippingData.district || !shippingData.city) {
    ...
    try {
      ...
      const invalidItems = createOrderRequest.items.filter(item => 
      ...
      for (const item of createOrderRequest.items) {
        try {
          ...
          if (product.stock < item.quantity) {
            toast.error(`Sản phẩm "${product.productName}" không đủ hàng. Còn lại: ${product.stock}, yêu cầu: ${item.quantity}`);
            return;
          }
        } catch (productError) {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white  shadow-sm border p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Select value={shippingData.ward} onValueChange={(value) => handleInputChange('ward', value)}>
                    <SelectTrigger className="rounded-none">
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="Phường Nguyễn Thái Bình">Phường Nguyễn Thái Bình</SelectItem>
                      <SelectItem value="Phường Cô Giang">Phường Cô Giang</SelectItem>
                      <SelectItem value="Phường Nguyễn Cư Trinh">Phường Nguyễn Cư Trinh</SelectItem>
                ...
                <div>
                  ...
                  <Select value={shippingData.district} onValueChange={(value) => handleInputChange('district', value)}>
                    <SelectTrigger className="rounded-none">
                ...
                <div>
                  ...
                  <Select value={shippingData.city} onValueChange={(value) => handleInputChange('city', value)}>
                    <SelectTrigger className="rounded-none">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white  shadow-sm border p-6">
              ...
              <div className="space-y-4">
                {cartItems.map((item) => (
                  <div key={item.cartItemId} className="flex items-center gap-4 p-4 border border-gray-200 ">
              ...
              <div className="space-y-3">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium">
                    {formatPrice(cartItems.reduce((total, item) => total + (item.productPrice * item.quantity), 0))}
                  </span>
                </div>
