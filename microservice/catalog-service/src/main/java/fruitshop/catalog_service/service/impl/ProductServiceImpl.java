...
public class ProductServiceImpl implements ProductService {
  ...
  @Override
  public Page<ProductResponse> filter(List<String> categoryIds, Integer status, Long minPrice, Long maxPrice,
      Pageable pageable) {
  ...
  public void decrementStock(String productId, int quantity) {
    ...
    if (currentStock < quantity) {
      log.warn("Stock insufficient for product {}. Current: {}, Requested: {}. Setting stock to 0.", productId,
