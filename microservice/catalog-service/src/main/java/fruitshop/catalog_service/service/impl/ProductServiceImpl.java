...
public class ProductServiceImpl implements ProductService {
    ...
    @Override
    public Page<Product> filter(List<String> categoryIds, Integer status, Long minPrice, Long maxPrice, Pageable pageable) {
        return productRepository.filter(categoryIds, status, minPrice, maxPrice, pageable);
    }
