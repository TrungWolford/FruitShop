...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderResponse create(CreateOrderRequest request) {
        ...
        if (request.getPaymentMethod() != null) {
            ...
            // Note: In microservice, the actual payment record creation is handled via Saga or Payment Service.
        ...
        // Monolith fallback: if shippingId not found, try to get latest account template
